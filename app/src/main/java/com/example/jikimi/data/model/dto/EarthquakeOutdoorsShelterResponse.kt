...
data class Row(
    ...
    @SerializedName("acmdfclty_sn") val acmdfcltySn: Int?,      //시설일련번호
    ...
    @SerializedName("fclty_ar") val fcltyAr: Int?,              // 시설 면적
    ...
    @SerializedName("vt_acmd_psbl_nmpr") val vtAcmdPsblNmpr: Int?,   // 최대수용인원수
